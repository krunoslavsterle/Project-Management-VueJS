        ...
        <div class="col-md-3">
            <div class="widget">
                <div class="block block-profile">
                    <img class="img-avatar" src="https://mdbootstrap.com/img/Photos/Avatars/img%20(1).jpg" alt="">
                    <h3>Denise Watson</h3>
                </div>
                            ...
                            <ul class="list-group">
                                <li class="list-group-item">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-10">
                                            <i class="glyphicon glyphicon-tag activity-icon color-general"></i>John Doe has updated your role. 
                                        </div>
                                        <div class="col-xs-2">
                                            11:45
                                        </div>
                                ...
                                <li class="list-group-item">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-10">
                                            <i class="glyphicon glyphicon-bell activity-icon color-warning"></i>John Doe has updated the status of a task: #236 to: in progress. 
                                        </div>
                                        <div class="col-xs-2">
                                            Yesterday
                                        </div>
                                 ...
                                 <li class="list-group-item">
                                    <div class="row">
                                        <div class="col-xs-10">
                                            <i class="glyphicon glyphicon-flash activity-icon color-alert"></i>John Doe has sent a new message to you. 
                                        </div>
                                        <div class="col-xs-2">
                                            Friday
                                        </div>
                                 ...
                                 <li class="list-group-item">
                                    <div class="row">
                                        <div class="col-xs-10">
                                            <i class="glyphicon glyphicon-flash activity-icon color-alert"></i>John Doe has assigned task #546 to you.
                                        </div>
                                        <div class="col-xs-2">
                                            Monday
                                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped list-group-tasks">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Implement ddl on Profile page</td>
                                            <td>Project 1</td>
                                            <td>In Progress</td>
                                            <td>23/7/2017</td>
                                            <td><a href="javascript:void(0)">View</a></td>
